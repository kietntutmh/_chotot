...
public class CM_Ads_Industrial extends BaseTest {
    final Logger log = LogManager.getLogger(getClass());
    AdsGroup adsGroup;
    String data, step;

    public void insertRequisite(List<String> insertData, List<String> stepDesc) {
    ...
    public void insertSpecializedItem(List<String> insertData, List<String> stepDesc) {
        adsGroup = new AdsGroup();
        for (int i = 0; i < insertData.size(); i++) {
            data = insertData.get(i);
            step = stepDesc.get(i);
