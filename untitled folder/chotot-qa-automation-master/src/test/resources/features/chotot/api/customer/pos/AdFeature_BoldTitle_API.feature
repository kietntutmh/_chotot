...
@POS_ADFEATURE_BOLDTITLE
Feature: POS Ad Feature NHÃN IN ĐẬM (BOLD TITLE LABEL) - API
...
#-------------------- PTY --------------------
 ...
 #-------------------- Entertainment --------------------
  ...
  Scenario: NHÃN IN ĐẬM, Service travel
    ...
    #--------------------- Shop PTY Sell Ad ---------------------
  @AUTHOR_VUHOANG_ME_API
  Scenario: NHÃN IN ĐẬM, Shop PTY House
    Given I login my account with Shop PTY
    When I post a new House Shop Ad then Chotot accepts my Ad - old images
#    And I publish my Shop Ad to Chợ Tốt
    When I add and pay for TITLE label to my PTY Shop "House" ad
    Then I should see my Ad is added TITLE In Đậm and not added Nhãn GIÁ TỐT, Nhãn HOT

  @AUTHOR_VUHOANG_ME_API
  Scenario: NHÃN IN ĐẬM, Shop PTY Land
    Given I login my account with Shop PTY
    When I post a new Land Shop Ad then Chotot accepts my Ad - old images
    When I add and pay for TITLE label to my PTY Shop "Land" ad
    Then I should see my Ad is added TITLE In Đậm and not added Nhãn GIÁ TỐT, Nhãn HOT

  @AUTHOR_VUHOANG_ME_API
  Scenario: NHÃN IN ĐẬM, Shop PTY Apartment
    Given I login my account with Shop PTY
    When I post a new Apartment Shop Ad then Chotot accepts my Ad - old images
    When I add and pay for TITLE label to my PTY Shop "Apartment" ad
    Then I should see my Ad is added TITLE In Đậm and not added Nhãn GIÁ TỐT, Nhãn HOT

  @AUTHOR_VUHOANG_ME_API
  Scenario: NHÃN IN ĐẬM, Shop PTY Office
    Given I login my account with Shop PTY
    When I post a new Office Shop Ad then Chotot accepts my Ad - old images
    When I add and pay for TITLE label to my PTY Shop "Office" ad
    Then I should see my Ad is added TITLE In Đậm and not added Nhãn GIÁ TỐT, Nhãn HOT

#  @AUTHOR_VUHOANG_ME_API
#  Scenario: NHÃN IN ĐẬM, Shop PTY Room
#    Given I login my account with Shop PTY
#    When I post a new Room Shop Ad then Chotot accepts my Ad - old images
#    When I add and pay for TITLE label to my PTY Shop "Room" ad
#    Then I should see my Ad is added TITLE In Đậm and not added Nhãn GIÁ TỐT, Nhãn HOT
